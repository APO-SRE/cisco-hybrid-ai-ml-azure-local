...
- [Deployment Options Diagram](#deployment-options-diagram)
...
- [Large Language Model (LLM) Deployment Models](#1-large-language-model-llm-deployment-models)
  - [Cloud Azure-Managed LLM](#11-cloud-azure-managed-llm)
  - [Cloud Self-Managed LLM (Containerized)](#12-cloud-self-managed-llm-containerized)
  - [On-Premises Self-Managed LLM (Containerized)](#13-on-premises-self-managed-llm-containerized)
- [Chat Endpoint and Machine Learning (ML) Deployment Models](#2-chat-endpoint-and-machine-learning-ml-deployment-models)
  - [Cloud Azure-Managed](#21-cloud-azure-managed)
  - [Cloud Self-Managed (Containerized)](#22-cloud-self-managed-containerized)
  - [On-Premises Azure-Managed](#23-on-premises-azure-managed)
  - [On-Premises Self-Managed (Containerized)](#24-on-premises-self-managed-containerized)
